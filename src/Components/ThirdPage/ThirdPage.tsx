    ...
    return(
        <div className="main">
            <div className="container">
                ...
                <Skill imgDesc={"React"} description={"I have build few projects with react ,react-redux and react router I'm able to solve different problems using this framework"} icon={"fab fa-react fa-5x"} color={"cyan"}/>
                <Skill imgDesc={"HTML5"} description={"I use it to build websites"} icon={"fab fa-html5 fa-5x"} color={"red"}/>
                <Skill imgDesc={"CSS3"} description={"I know how css works and able to make the website more alive"} icon={"fab fa-css3-alt fa-5x"} color={"darkblue"}/>
                ...
                <Skill imgDesc={"Typescript"} description={"I use typescript to develop staticly typed code"} icon={"fab fa-microsoft fa-5x"} color={"purple"}/>
                <Skill imgDesc={"NodeJs"} description={"I am able to run backend code aware of packet manager and all basic things needed to run some backend"} icon={"fab fa-node-js fa-5x"} color={"green"}/>
                {/* <Contact/> */}
