...
const Skill = ({ imgDesc, description, icon, color }: Props) => {
  ...
  return (
    <div
      ref={skill_ref}
      className="row border border-dark border-10px"
      style={{ margin: "4vh 4vh 4vh 4vh" }}
    >
      <div
        className="col"
        style={{
      ...
      >
        ...
        <div style={{ color: "white", paddingLeft: "5vh" }}>{imgDesc}</div>
      </div>
      <div
        className="col"
        style={{ color: "white", padding: "2vh 2vh 2vh 2vh" }}
      >
        {description}
      </div>
    </div>
